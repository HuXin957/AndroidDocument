...
import com.baseframework.BaseFrameworkSettings;
...
import static com.baseframework.BaseActivity.isNull;
import static com.baseframework.BaseFrameworkSettings.BETA_PLAN;
...
public class DebugLogG {
    ...
    public static String getCodeLineStr(boolean showStack) {
        ...
        for (int i = 0; i < stackTraceElements.length; i++) {
            if (stackTraceElements[i].getClassName().startsWith("com.baseframework.")) {
                findFrameworkPackage = true;
            }
            if (findFrameworkPackage && !stackTraceElements[i].getClassName().startsWith("com.baseframework.")) {
                line = i;
                break;
            }
        }
