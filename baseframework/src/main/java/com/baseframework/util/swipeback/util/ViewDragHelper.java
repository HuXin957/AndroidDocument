package com.baseframework.util.swipeback.util;
...
public class ViewDragHelper {
     ...
     * callback's
     * {@link  com.baseframework.util.swipeback.util.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link  com.baseframework.util.swipeback.util.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link  com.baseframework.util.swipeback.util.ViewDragHelper.Callback#tryCaptureView(android.view.View, int)}
     ...
     * {@link  com.baseframework.util.swipeback.util.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
